...
class DealsBabyAndToddler extends StatefulWidget {
  const DealsBabyAndToddler({super.key});
  @override
  State<DealsBabyAndToddler> createState() => _DealsBabyAndToddlerState();
}

class _DealsBabyAndToddlerState extends State<DealsBabyAndToddler>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (dealsController.dealsBabyToddler.isEmpty) {
        log("Baby & Toddler Running");
        dealsController.getDeals(
          cateSlug: "Baby-Toddler",
          page: 1,
      ...
      return Expanded(
        child: Column(
          children: [
            ...
            // if (!dealsController.getHasMoreData("Baby-Toddler") &&
            //     dealsController.getCategoryList("Baby-Toddler").isNotEmpty)
  ...
  Widget _buildProductGrid() {
    return Obx(() {
      ...
      return GridView.builder(
        ...
        itemCount:
            dealsController.dealsBabyToddler.length +
            (dealsController.isMoreLoading.value ? 1 : 0),
        itemBuilder: (context, index) {
          if (index == dealsController.dealsBabyToddler.length &&
              dealsController.dealsBabyToddler.isNotEmpty) {
            return Center(
          ...
          final item = dealsController.dealsBabyToddler[index];
