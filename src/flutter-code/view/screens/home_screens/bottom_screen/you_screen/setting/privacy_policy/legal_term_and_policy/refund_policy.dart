...
class _RefundPolicyState extends State<RefundPolicy> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((v) {
      if (privacyController.refundAndPolicy.value == null) {
        privacyController.getRefundPolicy();
      }
    });
    super.initState();
  }
      ...
      body: Obx(
        () => SingleChildScrollView(
          ...
          child: privacyController.isLoading.value
              ...
              : privacyController.refundAndPolicy.value == null
              ? Padding(
                  padding: EdgeInsets.only(top: 290.0.h),
                  child: Center(
                    child: AppTextWidget(text: "refundPolicyNotFound".tr),
                  ),
                )
              : Column(
