...
import '../../../controller/auth_controller/login_with_email_controller.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              AppButton(
                ...
                height: 50.h,
                onTap: () async {
                  await loginWithEmailController.verifyEmailOTP(
                    widget.email,
                    otp,
                    context,
                  );
              ...
              RichText(
                ...
                text: TextSpan(
                  ...
                  children: [
                    TextSpan(text: "byEnteringTheVerificationCode".tr),
                    TextSpan(
                      text: "termsOfUse".tr,
                      style: TextStyle(
                        color: AppColors.primaryColor,
